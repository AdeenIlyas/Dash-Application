...
app.layout = html.Div([
    ...
    html.Div([
        # TASK 2.2: Add a dropdown menu for selecting the year
        dcc.Dropdown(
            id='select-year',
...
# TASK 2.4: 
# Creating Callbacks Define the callback function to update the input container based on the selected statistics
@app.callback(
